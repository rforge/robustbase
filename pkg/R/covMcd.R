...
{
    pind <- p - MCDcnp2sim.p.min + 1
    if(p >= MCDcnp2sim.p.min && p <= MCDcnp2sim.p.max &&
       n >= MCDcnp2sim.n.min.rew[pind] && n <= MCDcnp2sim.n.max.rew[pind]) {
