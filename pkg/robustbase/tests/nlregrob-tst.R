...
Rfit.out.MM.lts.optimal <- update(Rfit.MM.S.bisquare, estim = "lts", psi = "optimal")
Rfit.out.MM.lts.hampel <- update(Rfit.MM.S.bisquare, estim = "lts", psi = "hampel")
...
Rfit.leverage.MM.lts.lqq <- update(Rfit.MM.S.bisquare, estim = "lts", psi = "lqq")
Rfit.leverage.MM.lts.optimal <- update(Rfit.MM.S.bisquare, estim = "lts", psi = "optimal")
Rfit.leverage.MM.lts.hampel <- update(Rfit.MM.S.bisquare, estim = "lts", psi = "hampel")
...
stopifnot(
    ...
    ## presence of high leverage point outliers
    ## all.equal( coef(Rfit.leverage.MM.S.bisquare), coef(Cfit), tolerance = 0.1 ),
    ## all.equal( coef(Rfit.leverage.MM.S.lqq), coef(Cfit), tolerance = 0.1 ),
    ## all.equal( coef(Rfit.leverage.MM.S.optimal), coef(Cfit), tolerance = 0.1 ),
    ## all.equal( coef(Rfit.leverage.MM.S.hampel), coef(Cfit), tolerance = 0.1 ),
    ...
    all.equal( coef(Rfit.leverage.tau.bisquare), coef(Cfit), tolerance = 0.1 ),
