...
print(ggplot(test.3, aes(p/n, sdlogsigma.1*sqrt(n), color = Est.Scale)) +
      ...
      stat_summary(data=test.lm.2, aes(color = Est.Scale),
...
\begin{figure}
\begin{center}
<<fig-sdscale-all,fig=TRUE,include=FALSE,echo=FALSE>>=
print(ggplot(test.4,
      ...
      stat_summary(data=test.lm, aes(color = Est.Scale), fun.y=median, geom='line') +
...
print(ggplot(t.2o., aes(p/n, AdB2.1/(1-p/n), color = Estimator)) +
      ...
      stat_summary(                         fun.y=median, geom='line') +
      stat_summary(aes(y=K2AdB2.1/(1-p/n)), fun.y=median, geom='line', linetype = 2) +
      stat_summary(aes(y=AdB2t.1),          fun.y=median, geom='line', linetype = 3) +
...
print(ggplot(t.2ok,
      ...
      stat_summary(                           fun.y=median, geom='line') +
      stat_summary(aes(y=sdK2AdB2.1/(1-p/n)), fun.y=median, geom='line', linetype = 2) +
      stat_summary(aes(y=sdAdB2t.1),          fun.y=median, geom='line', linetype = 3) +
      g.scale_y_log10_0.05() +
      scale_shape_discrete(quote(n)) +
...
t2.25  <- droplevels(subset(test.2,    n == 25))
